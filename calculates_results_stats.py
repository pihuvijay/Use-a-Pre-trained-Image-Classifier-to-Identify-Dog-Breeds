...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            ...
            if results_dic[key][3] == 1: 
                # Number of Images of dogs
                results_stats_dic['n_dogs_img'] += 1
                # Classifier Label is Dog
                if results_dic[key][4] == 1: 
                # Number of dog matches that are correct
                    results_stats_dic['n_correct_dogs'] += 1

                # Num of Correct Breed matches
                if results_dic[key][2] == 1:
               # Pet Image and Classifier Label match 
    ...
    results_stats_dic['n_images'] = len(results_dic)
     ...
     # Percentages from the Results Statistics dictionary counts:          
     # pct_match - percentage of correct matches
    results_stats_dic['pct_match'] = results_stats_dic['n_match'] /results_stats_dic['n_images'] * 100
     
    if results_stats_dic['n_dogs_img'] > 0:
            #percentage of  dogs that are correctly classified
